...
def lambda_handler(event, context):
    """
    Función Lambda para obtener los precios de energía y guardarlos en S3.
    """
    api_url = f"https://www.simem.co/backend-files/api/PublicData?startDate={fecha_inicio}&endDate={fecha_fin}&datasetId=96D56E"
    prefix = "EnergyPrice/"
